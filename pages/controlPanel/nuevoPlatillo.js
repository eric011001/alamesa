  ...
  const agregarExtra = () => {
    ...
    if (inputNombreExtra.current.value && inputPrecioExtra.current.value) {
      ...
      tempExtras.push({
        ...
        precio: inputPrecioExtra.current.value
      });
        ...
        <div className="flex-grow m-8 flex flex-col">
          ...
          <div className="flex flex-wrap">
            ...
            <div className="w-full sm:w-full md:w-full lg:w-1/3 xl:w-1/3 flex-shrink-0 flex flex-col">
              ...
              <div className="flex flex-row">
                ...
                <button className="bg-red-500 focus:bg-red-600 h-10 w-10 m-2 pt-1 text-2xl text-white rounded-lg outline-none transition-colors" onClick={() => agregarExtra()}>
          ...
          <div className="flex flex-wrap">
            <div className="w-full flex-shrink-0 flex flex-col">
              ...
              <textarea className="p-2 m-2 w-auto block bg-gray-200 focus:bg-gray-300 outline-none rounded-xl transition-colors"></textarea>
            </div>
          </div>
