...
const Index = () => {
  ...
  const mostrarMensaje = () => {
    ...
    <circle class="opacity-100" cx="12" cy="12" r="10" stroke="red" strokeWidth="4"></circle>
    <path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path>
  </svg>;
    return (
      <span className="block w-full flex justify-center items-center p-2 m-2 bg-gray-200 text-red-600 font-semibold rounded-lg">
  ...
  return ( 
    <>
      ...
      <div className="h-full flex justify-center">
        <form onSubmit= {formikLogin.handleSubmit} className="sm:w-full sm:mx-4 md:-2/3 lg:w-1/2 xl:w-1/3 h-1/2 my-auto">
